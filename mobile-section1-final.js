(() => {
  ...
  const SECTION_ID = 'ks-premium-intro-v3';
  const STYLE_ID = 'ks-premium-intro-style-v3';
  let scheduled = false;
  ...
  function injectStyles() {
    ...
    style.textContent = `
      :root{
        --ks-navy:#0b2f5b;--ks-ink:#3d5068;--ks-line:#dce5ef;--ks-gold:#dda91e;
        --ks-pink:#d94a76;--ks-pink-soft:#fff5f8;--ks-green:#2a855f;--ks-green-soft:#f4fbf7;
        --ks-blue:#2d69ae;--ks-blue-soft:#f4f8ff;--ks-orange:#c98222;--ks-orange-soft:#fff9ef;
      }

      /* Header: final layout. Enlarge only the Pro Tutor badge on tablet / desktop. */
      ...
      nav.fixed.top-0>.container>div>a:first-child>div:nth-child(2) span:first-child{display:block!important;color:#fff!important;font-family:"Noto Serif JP",serif!important;font-size:clamp(17px,2vw,24px)!important;font-weight:700!important;line-height:1.28!important}
      ...
      #${SECTION_ID}{width:100%!important;margin:0!important;padding:clamp(18px,3.5vw,42px) clamp(10px,2.8vw,28px)!important;background:linear-gradient(180deg,#f7f9fc 0%,#fff 100%)!important;color:var(--ks-ink)!important;overflow:hidden!important;font-family:"Noto Sans JP",sans-serif!important}
      #${SECTION_ID} .ks-intro__inner{width:min(100%,1180px)!important;margin:0 auto!important;padding:clamp(28px,4.8vw,56px) clamp(14px,4.5vw,52px)!important;border:1px solid var(--ks-line)!important;border-radius:clamp(20px,3vw,30px)!important;background:#fff!important;box-shadow:0 16px 46px rgba(23,53,86,.075)!important;text-align:center!important;overflow:hidden!important}

      #${SECTION_ID} .ks-intro__categories{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:clamp(10px,1.6vw,14px)!important;width:100%!important;margin:0 auto clamp(20px,2.8vw,28px)!important}
      #${SECTION_ID} .ks-intro__category{display:flex!important;align-items:center!important;justify-content:center!important;min-height:clamp(86px,10vw,112px)!important;padding:14px!important;border:1px solid #e7d6ab!important;border-radius:18px!important;background:linear-gradient(135deg,#fffdf8,#fff7e8)!important;font-family:"Noto Serif JP",serif!important;font-size:clamp(24px,3.2vw,34px)!important;font-weight:900!important;line-height:1.35!important;text-align:center!important;box-shadow:0 8px 20px rgba(88,62,14,.05)!important}
      #${SECTION_ID} .ks-intro__category--pink{color:#b83e65!important;border-top:5px solid var(--ks-pink)!important}
      #${SECTION_ID} .ks-intro__category--blue{color:#245f9f!important;border-top:5px solid var(--ks-blue)!important}

      #${SECTION_ID} .ks-intro__kicker{margin:0 auto clamp(20px,2.8vw,26px)!important;color:#174c87!important;font-size:clamp(13px,1.55vw,17px)!important;font-weight:900!important;line-height:1.65!important;text-align:center!important}
      #${SECTION_ID} .ks-intro__line{display:block!important;width:100%!important;text-align:center!important}
      #${SECTION_ID} .ks-intro__title{margin:0 auto clamp(18px,2.4vw,22px)!important;color:var(--ks-navy)!important;font-family:"Noto Serif JP",serif!important;font-size:clamp(25px,3.35vw,36px)!important;font-weight:900!important;line-height:1.48!important;text-align:center!important;white-space:normal!important}
      #${SECTION_ID} .ks-intro__resolution{margin:0 auto clamp(20px,2.7vw,28px)!important;color:#4f6075!important;font-size:clamp(13px,1.55vw,17px)!important;font-weight:500!important;line-height:1.8!important;text-align:center!important;white-space:nowrap!important}
      #${SECTION_ID} .ks-intro__rule{width:66px!important;height:4px!important;margin:0 auto clamp(24px,3vw,32px)!important;border-radius:999px!important;background:linear-gradient(90deg,var(--ks-gold),#efbd43)!important}
      #${SECTION_ID} .ks-intro__support{margin:0 auto clamp(18px,2.5vw,24px)!important;color:#43556d!important;font-size:clamp(12px,1.45vw,17px)!important;line-height:1.95!important;text-align:center!important}
      #${SECTION_ID} .ks-intro__planner{margin:0 auto clamp(28px,3.5vw,36px)!important;color:#53647a!important;font-size:clamp(12px,1.38vw,16px)!important;line-height:1.95!important;text-align:center!important}
      ...
      #${SECTION_ID} .ks-proof{display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:center!important;min-height:clamp(110px,12vw,145px)!important;padding:18px 10px!important;border:1px solid #ead39b!important;border-radius:18px!important;background:linear-gradient(135deg,#fffdf8,#fff7e8)!important;box-shadow:0 8px 20px rgba(88,62,14,.05)!important;text-align:center!important;overflow:hidden!important}
      ...
      @media(min-width:601px) and (max-width:1024px){
        ...
        #${SECTION_ID} .ks-intro__inner{padding:34px 26px!important}
        #${SECTION_ID} .ks-intro__categories{grid-template-columns:repeat(2,minmax(0,1fr))!important}
        #${SECTION_ID} .ks-intro__category{min-height:118px!important;font-size:clamp(25px,3.8vw,31px)!important}
        #${SECTION_ID} .ks-intro__kicker{font-size:clamp(13px,1.9vw,16px)!important}
        #${SECTION_ID} .ks-intro__title{font-size:clamp(26px,3.6vw,32px)!important}
        #${SECTION_ID} .ks-intro__resolution{font-size:clamp(13px,1.9vw,16px)!important}
        #${SECTION_ID} .ks-intro__support{font-size:clamp(12px,1.85vw,16px)!important}
        #${SECTION_ID} .ks-intro__planner{font-size:clamp(12px,1.75vw,15px)!important}
        #${SECTION_ID} .ks-intro__proofs{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:12px!important}
        #${SECTION_ID} .ks-proof{min-height:132px!important}
      ...
      @media(max-width:600px){
        ...
        #${SECTION_ID} .ks-intro__inner{padding:24px 12px!important;border-radius:20px!important}
        #${SECTION_ID} .ks-intro__categories{gap:7px!important;margin-bottom:20px!important}
        #${SECTION_ID} .ks-intro__category{min-height:72px!important;padding:10px 6px!important;border-radius:14px!important;font-size:clamp(18px,5.3vw,24px)!important}
        #${SECTION_ID} .ks-intro__kicker{font-size:clamp(11px,3.3vw,14px)!important;line-height:1.65!important}
        #${SECTION_ID} .ks-intro__title{font-size:clamp(21px,6vw,28px)!important}
        #${SECTION_ID} .ks-intro__resolution{font-size:clamp(10.5px,3vw,13px)!important}
        #${SECTION_ID} .ks-intro__support{font-size:clamp(10px,2.85vw,12.5px)!important;line-height:1.9!important}
        #${SECTION_ID} .ks-intro__planner{font-size:clamp(10px,2.8vw,12px)!important;line-height:1.9!important}
        #${SECTION_ID} .ks-intro__proofs{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:8px!important}
        #${SECTION_ID} .ks-proof{min-height:102px!important;padding:15px 6px!important;border-radius:14px!important}
        #${SECTION_ID} .ks-proof__value{font-size:clamp(19px,5.8vw,27px)!important}
      ...
      @media(max-width:359px){
        #${SECTION_ID} .ks-intro__category{font-size:17px!important}
        #${SECTION_ID} .ks-intro__resolution{font-size:10px!important}
        #${SECTION_ID} .ks-intro__support,#${SECTION_ID} .ks-intro__planner{font-size:9.8px!important}
      }
    `;
  ...
  function buildSection() {
    ...
    section.className = 'ks-first-section-v3';
    ...
    section.innerHTML = `
      <div class="ks-intro__inner">
        ...
        <div class="ks-intro__direct">
          ...
          <div class="ks-intro__actions"><a class="ks-intro__cta ks-intro__cta--primary" href="#contact">無料相談・体験授業について相談する</a><a class="ks-intro__cta ks-intro__cta--secondary" href="/hikaku/">料金・担当体制を比較して見る</a></div>
        </div>
      </div>`;
    return section;
  }
  ...
  function removeKnownLegacy() {
    ...
    ['ks-premium-intro-v1','ks-premium-intro-v2'].forEach(id => document.getElementById(id)?.remove());
  }

  function findLegacyIntro(main) {
    const candidates = Array.from(main.querySelectorAll('h1,h2,h3,h4,p,strong,div,span'))
      .filter(el => !el.closest('#' + SECTION_ID));
    const heading = candidates.find(el => {
      const t = norm(el.textContent).replace(/[「」]/g,'');
      return t === 'うちの子に合う先生が見つからない';
    });
  ...
  function rebuild() {
    ...
    if (legacy) {
      const replacement = fresh || buildSection();
      if (fresh && fresh !== legacy) fresh.remove();
      legacy.replaceWith(replacement);
      fresh = replacement;
    } else if (!fresh) {
      fresh = buildSection();
      const hero = main.firstElementChild;
      if (hero) hero.insertAdjacentElement('afterend', fresh);
      else main.prepend(fresh);
    }

    main.querySelectorAll('.ks-mobile-section1-final').forEach(el => {
      if (!el.closest('#' + SECTION_ID)) el.remove();
    });
  }
