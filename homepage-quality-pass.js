(() => {
  ...
  const STYLE_ID = "ks-homepage-quality-pass-style-v5";
  const SECTION_ID = "ks-direct-contract-proof-v5";
  ...
  const injectStyles = () => {
    ...
    style.textContent = `
      ...
      #${SECTION_ID} .ks-proof-heading { max-width:800px; margin:0 auto 1.75rem; text-align:center; }
      ...
      #${SECTION_ID} .ks-proof-lead { margin:.8rem auto 0; max-width:730px; color:rgba(255,255,255,.84) !important; font-size:.98rem; line-height:1.9; }
      ...
      #${SECTION_ID} .ks-credibility-item { padding:1rem 1.1rem; border:1px solid rgba(255,255,255,.16); border-radius:14px; background:rgba(255,255,255,.06) !important; }
      ...
      #${SECTION_ID} .ks-proof-cta a { display:inline-flex; align-items:center; justify-content:center; min-height:48px; padding:.7rem 1.35rem; border:1px solid rgba(255,255,255,.35); border-radius:999px; color:#fff !important; background:rgba(255,255,255,.08) !important; text-decoration:none !important; font-weight:700; }
  ...
  const createSection = () => {
    ...
    section.setAttribute("aria-labelledby", "ks-direct-contract-proof-title-v5");
    section.innerHTML = `
      <div class="ks-proof-inner">
        <div class="ks-proof-heading">
          <p class="ks-proof-kicker">DIRECT CONTRACT</p>
          <h2 id="ks-direct-contract-proof-title-v5">講師を紹介してもらうのではなく、<br>講師本人と直接契約する家庭教師です。</h2>
